...
<button type="button" onclick="location.href='Course CSS.php?click=remove';" class="btn btn-danger" id="cancel" style="display: none;margin-left:20%; margin-top:20px;"><a style="text-decoration:none; color:white;" href="certificates/css.png" download="Fundamentals of CSS Course Certificate">De-enroll From The Course</a></button>
