...
<button type="button" onclick="location.href='Course JS.php?click=remove';" class="btn btn-danger" id="cancel" style="display: none;margin-left:20%; margin-top:20px;"><a style="text-decoration:none; color:white;" href="certificates/js.png" download="Fundamentals of JavaScript Course Certificate">De-enroll From The Course</a></button>
