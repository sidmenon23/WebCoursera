...
<button type="button" onclick="location.href='Course Java.php?click=remove';" class="btn btn-danger" id="cancel" style="display: none;margin-left:20%; margin-top:20px;"><a style="text-decoration:none; color:white;" href="certificates/java.png" download="Fundamentals of Java Course Certificate">De-enroll From The Course</a></button>
